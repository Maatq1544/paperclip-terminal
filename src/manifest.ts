...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description:
    "Interactive server terminal for Paperclip. Execute shell commands and manage persistent PTY sessions directly from the project view.",
  ...
  tools: [
    {
      ...
      description:
        "Execute a shell command on the server and return stdout + stderr. Use this for one-shot commands. For interactive sessions use Terminal: New Session.",
      parametersSchema: {
        type: "object",
        required: ["command"],
        properties: {
